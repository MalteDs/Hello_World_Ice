...
{
    default void receiveMessage(String sender, String message)
    {
        receiveMessage(sender, message, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void receiveMessage(String sender, String message, java.util.Map<String, String> context)
    {
        _iceI_receiveMessageAsync(sender, message, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> receiveMessageAsync(String sender, String message)
    {
        return _iceI_receiveMessageAsync(sender, message, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> receiveMessageAsync(String sender, String message, java.util.Map<String, String> context)
    {
        return _iceI_receiveMessageAsync(sender, message, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_receiveMessageAsync(String iceP_sender, String iceP_message, java.util.Map<String, String> context, boolean sync)
    {
